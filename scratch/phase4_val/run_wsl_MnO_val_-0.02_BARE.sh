...
mpirun -np 1 /home/jmc/.local/siesta-5.4.2-serial/bin/siesta < MnO_val_-0.02_BARE.fdf > MnO_val_-0.02_BARE.out
EOF
...
cp /tmp/siesta_run_MnO_val_-0.02_BARE/MnO_val_-0.02_BARE.out /mnt/c/Users/Jairo/Downloads/SIESTAFLOW_HUBBARD_RESPONSE_BACKBONE_V0_1_0/scratch/phase4_val/ 2>/dev/null || true
